...
export default function ActiveDemoPage() {
  return (
    <div className="min-h-screen flex flex-col">
      <div className="fixed top-0 left-0 right-0 z-50 bg-green-600 text-white p-2 flex justify-between items-center">
        <span className="font-bold">DEMO - LISTA ATIVA</span>
